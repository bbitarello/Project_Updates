...
google_Scholar <- function(user_query,year_low=NULL,year_high=NULL,journal=NULL){
        ...
        base_URL <- "http://api.scraperapi.com/?api_key=b24f43c54d91c276ff8d9d7a7231c6a1&url=https://scholar.google.com/scholar?hl=en&as_sdt=0%2C39&num=1000&q="
       ...
       #         html_nodes(".gs_rs") %>%
        ...
        result <- data.frame(title=getTitles,link=getLinks)
