...
cols<-c("#D8A499","#DD8D29","#899DA4","#5F5647","#A2A475","#7294D4","#550307", "#F1BB7B","#5BBCD6", "#B40F20", "#354823", "#D69C4E")
...
g1000$Label<-factor(g1000$Label,levels=levels(factor(g1000$Label,levels=levels(factor(g1000$Label))))[c(2,3,8,1,10,4,7,5,6,11,9)])
...
scale_fill_manual(values=cols3, name="Populations") + xlim(c(-5.5,5.5)) + ylim(c(0,1.4))  + theme_bw()
