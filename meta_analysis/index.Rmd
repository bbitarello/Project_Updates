...
theme_bw() + 
labs(x="Alpha",y="", title="") + theme(axis.text.x = element_text(size=12), axis.text.y = element_text(size=12), axis.title.y=element_text(size=rel(1.4)))+
...
cowplot::plot_grid(pD,pE, nrow=1, labels=c("HRS_AFR", "PMBB_AFR"), rel_widths=c(0.4, 0.6))
```
