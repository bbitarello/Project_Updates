...
setkey(samples, IID)
lapply(1:10,function(x) g1000[[x]][,Summary_Stats:=names(g1000)[x]])
...
```{r, chunk='Fig4', out.height = "960px",out.width="960px",echo=FALSE, eval=T, fig.cap="Fig 4: 1000 GENOMES"}
#p1000_A<-ggplotly(p1000_A)
#p1000_B<-ggplotly(p1000_B)
#p1000_C<-ggplotly(p1000_C)
#subplot(p1000_A, p1000_B, p1000_C, nrows=3)
