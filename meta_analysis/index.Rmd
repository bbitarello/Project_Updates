...
```{r, chunk='Fig2',out.height = "560px",out.width="960px",echo=FALSE, eval=T, fig.cap="Fig 3: Proportion of variance explained. PRS calculated using linear combinations of PRS weights from LDpred-inf (PRS1, PRS2) and using local ancestry PRS (PRS3).HRS_AFR and PMBB_AFR"}
subplot(subplot(style(ggplotly(pD), showlegend=F), ggplotly(pE), rows=1), ggplotly(pF), nrows = 2)
```
