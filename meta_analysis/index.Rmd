...
```{r, echo=F}
dt2<-data.table(Datasets=c('meta-AFR', 'meta-ALL'), Lambda=c(NA,NA),  TotalSampleSize=c(),SampleSizeThresh=c(90000,590000), N_pos_QC=c(2959565, 2298328))
...
p2<-ggplot(dt, aes(x=Test, y=R2,color=Summary_Stats)) +
geom_jitter(size=5, alpha=0.9, width=0.2) + 
#facet_wrap(~variable, nrow=2, scales='free')  +     
scale_color_manual(name='',values = wes_palette("Moonrise3",4), labels=c('BBJ_eas','meta-AFR','meta-ALL','UKBB_eur')) + 
