...
dt[,Total_other:=Total-Total_AFR] [,N_SNPs:=c(11941213,24704819,3166314,25887135,25376652,20512513)][,N_SNPs_QC:=c(11939557,NA,NA,NA,15477000,NA)]
...
```{r, echo=F}
dt2<-data.table(Datasets=c('meta-AFR', 'meta-ALL'), Lambda=c(1.02,"-"),  TotalSampleSize=c(),SampleSizeThresh=c(90000,590000), N_pos_QC=c(2959565, 2298328))
...
```{r, chunk='R2_table', out.height = "460px",out.width="660px",echo=FALSE, eval=T, fig.cap="Fig 4: Proportion of variance explained. LDpred-Inf with sumamry statistics from UKBB, BBJ, meta-AFR, and meta-ALL. Bootrstrap confidence intervals (n=1,000)"}
dt=fread('ldpred_table.txt')
#dt[,AIC:=round(AIC,1)]
...
theme_bw()+ labs(ylab="Variance explained (%)", title="")
ggplotly(p2)
