...
```{r, chunk='Fig 2', out.height = "460px",out.width="960px",echo=FALSE, eval=T, fig.cap="Fig 2: Proportion of variance explained when using 1000G (all) as LD reference panel vs. using ancestry-matching LD panels."}
dt=lapply(c("anc_specific", "1000g_all"), function(x) fread(paste0('ldpred_table_radius1000_boots_5000_ldpanel_', x, '.txt'))[, LD_panel:=x])
dt<-do.call(rbind, dt)
dt[, Summary_Stats:=gsub("PRS_", "", Summary_Stats)]
dt[,Label:=paste0(Label, ";", N)]
...
```{r, chunk='Fig3', out.height = "1260px",out.width="960px",echo=FALSE, eval=T, fig.cap="Fig 4: PRS for height for 2,503 individuals from the 1000 Genomes Project. PRS values are scaled around the mean and standard deviations of PRS for the EUR population, for each set of summary statistics."}
