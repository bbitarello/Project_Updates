...
prs3[,variable:='PRS3']
setnames(prs3,'PRS_3','value')
prs3[, Label:=ifelse(Test_Data=='PMBB_AFR', "PMBB_AFR\n(8673)", "HRS_AFR\n(2241)")]
prs3<-prs3[,.(Set, Test_Data, Alpha, variable, value, Label, Label2)]
RES2<-rbind(RES, prs3)
...
pD<-ggplot(RES2[Test_Data=="HRS_AFR"][Set %in% c("UKBB--META_NEA", "META_EUR--META_NEA")])+
geom_line(aes(x=Alpha, y=value, color=Set, linetype=PRS), size=0.6, show.legend=F) + geom_point(data=expnd[Test_Data=="HRS_AFR"][c(1:3)],aes(x=Alpha, y=value, color=Set), size=2.5, col=cols[c(9,5,4)], alpha=c(0.8, 0.8, 0.8)) + facet_wrap(~Label2) +
...
pE<-ggplot(RES2[Test_Data=="PMBB_AFR"][Set %in% c("UKBB--META_NEA", "META_EUR--META_NEA")])+
geom_line(aes(x=Alpha, y=value, color=Set, linetype=PRS), size=0.6, show.legend=T) + 
        geom_point(data=expnd[Test_Data=="PMBB_AFR"][c(1:3)],aes(x=Alpha, y=value), size=2, col=cols[c(9,5,4)], alpha=c(0.8, 0.8, 0.8)) + facet_wrap(~Label2) +
...
pF<-ggplot(RES2[Test_Data=="UKB_CHI"][Set %in% c("UKBB--BBJ", "META_EUR--BBJ")])+
geom_line(aes(x=Alpha, y=value, color=Set, linetype=PRS), size=0.6, show.legend=T) + 
...
geom_hline(yintercept=expnd[Test_Data=="UKB_CHI"][Set=="META_ALL2"]$value,  col="darkgray")+
        theme(axis.text.x = element_text(size=12), axis.text.y = element_text(size=12),axis.title.y=element_text(size=rel(1.4)), legend.title = element_blank())
#
pF<-pF+ annotate("text", x = 0.1, y = 14, label = "UKB_CHI", size=4)
```
