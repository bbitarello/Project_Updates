...
cols<-c("#D8A499","#DD8D29","#899DA4","#5F5647","#A2A475","#7294D4","#550307", "#F1BB7B","#5BBCD6", "#B40F20", "#354823", "#FAD77B")
...
geom_point(aes(shape=Test, colour=Label), size=2.5, alpha=0.8, fill='white', show.legend=T) +
        geom_errorbarh(aes(xmin=R2+SE, xmax=R2-SE, colour=Label), width=0.03, linetype = "dotted", alpha=0.5)+
        geom_errorbar(aes(ymin=y+SE.y, ymax=y-SE.y, colour=Label), width=0.03, linetype = "dotted", alpha=0.5)+
...
subplot(p2g, p3g, nrows = 2, heights = c(0.55, 0.45))
...
geom_line(aes(x=Alpha, y=value, color=Set, linetype=PRS), size=0.6, show.legend=F) + geom_point(data=expnd[Test_Data=="HRS_AFR"][1:3],aes(x=Alpha, y=value, color=Set), size=2.5, col=cols[c(7,5,9)], alpha=c(0.8, 0.8, 0.8)) +
scale_color_manual(values = cols2) + scale_y_continuous(breaks = seq(0, 10, by = 1)) +
theme_bw() + 
labs(x="Alpha",y="Variance explained (%)", title="") + theme(axis.text.x = element_text(size=12), axis.text.y = element_text(size=12), axis.title.y=element_text(size=rel(1.4)), legend.position="none")+
...
#
pD<-pD+ annotate("text", x = 0.05, y = 8.5, label = "HRS_AFR")
#
...
#
pE<-pE+ annotate("text", x = 0.05, y = 8.5, label = "PMBB_AFR")
#
...
scale_color_manual(name="",values = cols2) + scale_y_continuous(breaks = seq(0, 15, by = 2)) +
theme_bw() + 
labs(x="Alpha",y="Variance explained (%)", title="", legend="") + 
geom_text(data=expnd[Test_Data=="UKB_CHI"][1:3,], aes(x=Alpha, y=value, label=Set), nudge_x=c(-0.01, 0.01, -0.005),nudge_y=c(-0.1,0.15, 0.15), check_overlap=T, size=c(3,3,3))+
        theme(axis.text.x = element_text(size=12), axis.text.y = element_text(size=12),axis.title.y=element_text(size=rel(1.4)), legend.title = element_blank())
#
pF<-pF+ annotate("text", x = 0.05, y = 14, label = "UKB_CHI")
```
...
g1000$Label<-factor(g1000$Label,levels=levels(factor(g1000$Label,levels=levels(factor(g1000$Label))))[c(3,2,4,10,9,11,5,8,6,7,12,1)])
