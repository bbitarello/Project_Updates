...
```{r, chunk='Fig2', out.height = "860px",out.width="760px",echo=FALSE, eval=T, fig.cap="Fig 2: Proportion of variance explained. PRS calculated using linear combinations of PRS weights from LDpred-inf (PRS1, PRS2) and using local ancestry PRS (PRS3)."}
set.seed(4194)
...
geom_line(aes(x=Alpha, y=value, color=Set, linetype=PRS), size=0.9) + geom_point(data=expnd[Test_Data=="HRS_AFR"][1:3],aes(x=Alpha, y=value, color=Set), size=1.8, col=cols[c(7,5,9)]) +
...
cowplot::plot_grid(pD,pE, nrow=2)
```
