...
geom_density(alpha=0.6) + labs(x="Density",x="Scaled Polygenic Score", title="")+
        facet_wrap(~Label, labeller = label_wrap_gen(width=2), nrow=1) +
theme(axis.text.x = element_text(size=12), axis.text.y = element_text(size=12), axis.title.y=element_text(size=rel(1.4)),legend.position="none", legend.direction="horizontal", plot.margin = margin(4, 4, 4, 4, "cm"))+
scale_fill_manual(values=cols3, name="Populations") + xlim(c(-10,10)) + ylim(c(0,1.2))
...
t <- 
plotly::subplot(plotly::ggplotly(p1000_A), plotly::ggplotly(p1000_B), plotly::ggplotly(p1000_C), nrows=3)
