...
geom_line(aes(x=Alpha, y=value, color=Set, linetype=PRS), size=0.6, show.legend=T) + 
  geom_text(data=expnd[Test_Data=="UKB_CHI"][c(1:3,6),], aes(x=Alpha, y=value, label=Set), nudge_x=c(-0.02,-0.03,-0.02, -0.03), nudge_y=c(-0.05, -0.05, 0.05, 0.1), check_overlap=T, size=3)+
scale_color_manual(name="",values = cols2) + scale_y_continuous(breaks = seq(0, 10, by = 1)) +
theme_bw() + 
